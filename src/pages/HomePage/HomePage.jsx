...
import { randomAuthors, randomBooks } from "../../component/Utils/fakeData";
function HomePage() {
  ...
  useEffect(() => {
    const fetchAuthors = async () => {
      try {
        const response = await fetch("http://cloudcomputingpipeline-boot-app:8080/api/tacgia/getntacgia/10");
